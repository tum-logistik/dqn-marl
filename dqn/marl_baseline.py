...
def run_marl_baseline(MARLAgent, 
    ...
    for i in range(episodes):
        ...
        while(status == 1):
            ...
            epsilon_nash_arr, value_sum_bbo, policy_bbo, sna_policy_dict_iter = turbo_optimize_max_reward(marketEnv, sna_policy_dict, MARLAgent)
